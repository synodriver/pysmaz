 ...
 */
  __pyx_v_output_ptr = PyBytes_AS_STRING(__pyx_v_output);
 ...
 */
        __pyx_t_3 = 0;
        __pyx_v_buffer_updated = smaz_compress(((char *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_3)) ))))), ((int)__pyx_v_input_len), __pyx_v_output_ptr, ((int)__pyx_v_output_size));
      }
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":20
 *     with nogil:
 *         buffer_updated = smaz_compress(<char*>&data[0], <int>input_len, output_ptr, <int>output_size)
 *     if buffer_updated == <int>input_len+1:             # <<<<<<<<<<<<<<
 *         raise ValueError("output buffer is too small")
 ...
 */
  ...
  __pyx_t_2 = PySequence_GetSlice(__pyx_v_output, 0, __pyx_v_buffer_updated); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":27
 * cpdef inline bytes decompress(const uint8_t[::1] data, Py_ssize_t output_size = 0):
 *     cdef Py_ssize_t input_len = data.shape[0]
 *     if output_size==0:             # <<<<<<<<<<<<<<
 *         output_size = input_len * 2 # buffer2
 ...
 *         raise MemoryError
 */
  __pyx_t_2 = PyBytes_FromStringAndSize(NULL, __pyx_v_output_size); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_output = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "pysmaz/backends/cython/_smaz_cy.pyx":31
 * 
 *     cdef bytes output = PyBytes_FromStringAndSize(NULL, output_size)
 *     if <void*>output == NULL:             # <<<<<<<<<<<<<<
 *         raise MemoryError
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":35
 *     cdef int buffer_updated
 *     cdef char *output_ptr = PyBytes_AS_STRING(output)
 *     with nogil:             # <<<<<<<<<<<<<<
 *         buffer_updated = smaz_decompress(<char*>&data[0], <int>input_len, output_ptr, <int>output_size)
 ...
 */
        __pyx_t_3 = 0;
        __pyx_v_buffer_updated = smaz_decompress(((char *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_3)) ))))), ((int)__pyx_v_input_len), __pyx_v_output_ptr, ((int)__pyx_v_output_size));
      }
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":37
 *     with nogil:
 *         buffer_updated = smaz_decompress(<char*>&data[0], <int>input_len, output_ptr, <int>output_size)
 *     if buffer_updated == <int>output_size+1:             # <<<<<<<<<<<<<<
 *         raise ValueError("output buffer is too small")
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pysmaz/backends/cython/_smaz_cy.pyx":38
 *         buffer_updated = smaz_decompress(<char*>&data[0], <int>input_len, output_ptr, <int>output_size)
 *     if buffer_updated == <int>output_size+1:
 *         raise ValueError("output buffer is too small")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = PySequence_GetSlice(__pyx_v_output, 0, __pyx_v_buffer_updated); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_3decompress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("decompress (wrapper)", 0);
  {
    ...
    if (values[1]) {
      __pyx_v_output_size = __Pyx_PyIndex_AsSsize_t(values[1]); if (unlikely((__pyx_v_output_size == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    } else {
      __pyx_v_output_size = ((Py_ssize_t)0);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("decompress", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 25, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pysmaz.backends.cython._smaz_cy.decompress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_2decompress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, Py_ssize_t __pyx_v_output_size) {
  ...
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.output_size = __pyx_v_output_size;
  __pyx_t_1 = __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_decompress(__pyx_v_data, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_5compress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("compress_into (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_output)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("compress_into", 1, 2, 2, 1); __PYX_ERR(0, 43, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "compress_into") < 0)) __PYX_ERR(0, 43, __pyx_L3_error)
      }
    ...
    __pyx_v_output = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_output.memview)) __PYX_ERR(0, 43, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compress_into", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 43, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pysmaz.backends.cython._smaz_cy.compress_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_4compress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_output) {
  ...
  __pyx_t_1 = __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_compress_into(__pyx_v_data, __pyx_v_output, 0); if (unlikely(__pyx_t_1 == ((int)-1) && PyErr_Occurred())) __PYX_ERR(0, 43, __pyx_L1_error)
...
/* "pysmaz/backends/cython/_smaz_cy.pyx":52
 *     return ret
 * 
 * cpdef inline int decompress_into(const uint8_t[::1] data, uint8_t[::1] output) except *:             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t output_size = output.shape[0]
...
static CYTHON_INLINE int __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_decompress_into(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_output, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":53
 * 
 * cpdef inline int decompress_into(const uint8_t[::1] data, uint8_t[::1] output) except *:
 *     cdef Py_ssize_t output_size = output.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int ret
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":55
 *     cdef Py_ssize_t output_size = output.shape[0]
 *     cdef int ret
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pysmaz/backends/cython/_smaz_cy.pyx":56
 *     cdef int ret
 *     with nogil:
 *         ret =  smaz_decompress(<char *> &data[0], <int> data.shape[0], <char*>&output[0], <int>output_size)             # <<<<<<<<<<<<<<
 *     if ret == <int>output_size + 1:
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":57
 *     with nogil:
 *         ret =  smaz_decompress(<char *> &data[0], <int> data.shape[0], <char*>&output[0], <int>output_size)
 *     if ret == <int>output_size + 1:             # <<<<<<<<<<<<<<
 *         raise ValueError("output buffer is too small")
 ...
 */
  ...
  if (unlikely(__pyx_t_3)) {
    ...
    /* "pysmaz/backends/cython/_smaz_cy.pyx":58
 *         ret =  smaz_decompress(<char *> &data[0], <int> data.shape[0], <char*>&output[0], <int>output_size)
 *     if ret == <int>output_size + 1:
 *         raise ValueError("output buffer is too small")             # <<<<<<<<<<<<<<
 *     return ret
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":59
 *     if ret == <int>output_size + 1:
 *         raise ValueError("output buffer is too small")
 *     return ret             # <<<<<<<<<<<<<<
 */
...
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_7decompress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("decompress_into (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_output)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("decompress_into", 1, 2, 2, 1); __PYX_ERR(0, 52, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "decompress_into") < 0)) __PYX_ERR(0, 52, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_output = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_output.memview)) __PYX_ERR(0, 52, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("decompress_into", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 52, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pysmaz.backends.cython._smaz_cy.decompress_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_6decompress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_output) {
  ...
  if (unlikely(!__pyx_v_output.memview)) { __Pyx_RaiseUnboundLocalError("output"); __PYX_ERR(0, 52, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_decompress_into(__pyx_v_data, __pyx_v_output, 0); if (unlikely(__pyx_t_1 == ((int)-1) && PyErr_Occurred())) __PYX_ERR(0, 52, __pyx_L1_error)
 ...
 *     return output[:buffer_updated]
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_output_buffer_is_too_small); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 21, __pyx_L1_error)
