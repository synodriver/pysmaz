...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "pysmaz.backends.cython._smaz_cy",
        "sources": [
            "pysmaz/backends/cython/_smaz_cy.pyx",
            "./smaz/smaz.c"
        ]
    },
    "module_name": "pysmaz.backends.cython._smaz_cy"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pysmaz__backends__cython___smaz_cy
#define __PYX_HAVE_API__pysmaz__backends__cython___smaz_cy
/* Early includes */
#include <string.h>
#include <stdio.h>
#include <stdint.h>
...
struct __pyx_opt_args_6pysmaz_8backends_6cython_8_smaz_cy_compress;
struct __pyx_opt_args_6pysmaz_8backends_6cython_8_smaz_cy_decompress;

/* "pysmaz/backends/cython/_smaz_cy.pyx":9
 * 
 * 
...
/* "pysmaz/backends/cython/_smaz_cy.pyx":23
...
/* Module declarations from 'pysmaz.backends.cython.smaz' */

/* Module declarations from 'pysmaz.backends.cython._smaz_cy' */
...
static CYTHON_INLINE PyObject *__pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_compress(__Pyx_memviewslice, int __pyx_skip_dispatch, struct __pyx_opt_args_6pysmaz_8backends_6cython_8_smaz_cy_compress *__pyx_optional_args); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_decompress(__Pyx_memviewslice, int __pyx_skip_dispatch, struct __pyx_opt_args_6pysmaz_8backends_6cython_8_smaz_cy_decompress *__pyx_optional_args); /*proto*/
static CYTHON_INLINE int __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_compress_into(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE int __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_decompress_into(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "pysmaz.backends.cython._smaz_cy"
extern int __pyx_module_is_main_pysmaz__backends__cython___smaz_cy;
int __pyx_module_is_main_pysmaz__backends__cython___smaz_cy = 0;

/* Implementation of 'pysmaz.backends.cython._smaz_cy' */
...
static PyObject *__pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_compress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, Py_ssize_t __pyx_v_output_size); /* proto */
static PyObject *__pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_2decompress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, Py_ssize_t __pyx_v_output_size); /* proto */
static PyObject *__pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_4compress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_output); /* proto */
static PyObject *__pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_6decompress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_output); /* proto */
...
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_1compress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_compress(__Pyx_memviewslice __pyx_v_data, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_6pysmaz_8backends_6cython_8_smaz_cy_compress *__pyx_optional_args) {
  Py_ssize_t __pyx_v_output_size = ((Py_ssize_t)0);
  Py_ssize_t __pyx_v_input_len;
  PyObject *__pyx_v_output = 0;
  int __pyx_v_buffer_updated;
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":10
 * 
 * cpdef inline bytes compress(const uint8_t[::1] data, Py_ssize_t output_size = 0):
 *     cdef Py_ssize_t input_len = data.shape[0]             # <<<<<<<<<<<<<<
 *     if output_size==0:
 *         output_size = input_len # buffer2
 */
  __pyx_v_input_len = (__pyx_v_data.shape[0]);

  /* "pysmaz/backends/cython/_smaz_cy.pyx":11
 * cpdef inline bytes compress(const uint8_t[::1] data, Py_ssize_t output_size = 0):
 *     cdef Py_ssize_t input_len = data.shape[0]
 *     if output_size==0:             # <<<<<<<<<<<<<<
 *         output_size = input_len # buffer2
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "pysmaz/backends/cython/_smaz_cy.pyx":12
 *     cdef Py_ssize_t input_len = data.shape[0]
 *     if output_size==0:
 *         output_size = input_len # buffer2             # <<<<<<<<<<<<<<
 *     cdef bytes output = PyBytes_FromStringAndSize(NULL, output_size)
 *     if <void*>output == NULL:
 */
    __pyx_v_output_size = __pyx_v_input_len;
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":13
 *     if output_size==0:
 *         output_size = input_len # buffer2
 *     cdef bytes output = PyBytes_FromStringAndSize(NULL, output_size)             # <<<<<<<<<<<<<<
 *     if <void*>output == NULL:
 *         raise MemoryError
 */
  __pyx_t_2 = PyBytes_FromStringAndSize(NULL, __pyx_v_output_size); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_output = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "pysmaz/backends/cython/_smaz_cy.pyx":14
 *         output_size = input_len # buffer2
 *     cdef bytes output = PyBytes_FromStringAndSize(NULL, output_size)
 *     if <void*>output == NULL:             # <<<<<<<<<<<<<<
 *         raise MemoryError
 * 
 */
  __pyx_t_1 = ((((void *)__pyx_v_output) == NULL) != 0);
  if (unlikely(__pyx_t_1)) {

    /* "pysmaz/backends/cython/_smaz_cy.pyx":15
 *     cdef bytes output = PyBytes_FromStringAndSize(NULL, output_size)
 *     if <void*>output == NULL:
 *         raise MemoryError             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":17
 *         raise MemoryError
 * 
 *     cdef int buffer_updated = smaz_compress(<char*>&data[0], <int>input_len, PyBytes_AS_STRING(output), <int>output_size)             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_3 = 0;
  __pyx_v_buffer_updated = smaz_compress(((char *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_3)) ))))), ((int)__pyx_v_input_len), PyBytes_AS_STRING(__pyx_v_output), ((int)__pyx_v_output_size));

  /* "pysmaz/backends/cython/_smaz_cy.pyx":18
 * 
 *     cdef int buffer_updated = smaz_compress(<char*>&data[0], <int>input_len, PyBytes_AS_STRING(output), <int>output_size)
 *     if buffer_updated == <int>input_len+1:             # <<<<<<<<<<<<<<
 *         raise ValueError("output buffer is too small")
 * 
 */
  __pyx_t_1 = ((__pyx_v_buffer_updated == (((int)__pyx_v_input_len) + 1)) != 0);
  if (unlikely(__pyx_t_1)) {

    /* "pysmaz/backends/cython/_smaz_cy.pyx":19
 *     cdef int buffer_updated = smaz_compress(<char*>&data[0], <int>input_len, PyBytes_AS_STRING(output), <int>output_size)
 *     if buffer_updated == <int>input_len+1:
 *         raise ValueError("output buffer is too small")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":21
 *         raise ValueError("output buffer is too small")
 * 
 *     return output[:buffer_updated]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = PySequence_GetSlice(__pyx_v_output, 0, __pyx_v_buffer_updated); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_AddTraceback("pysmaz.backends.cython._smaz_cy.compress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_1compress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6pysmaz_8backends_6cython_8_smaz_cy_compress[] = "compress(const uint8_t[::1] data, Py_ssize_t output_size=0) -> bytes";
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_1compress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("compress (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "compress") < 0)) __PYX_ERR(0, 9, __pyx_L3_error)
      }
    } else {
    ...
    if (values[1]) {
      __pyx_v_output_size = __Pyx_PyIndex_AsSsize_t(values[1]); if (unlikely((__pyx_v_output_size == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("compress", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pysmaz.backends.cython._smaz_cy.compress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_compress(__pyx_self, __pyx_v_data, __pyx_v_output_size);
...
static PyObject *__pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_compress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, Py_ssize_t __pyx_v_output_size) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_6pysmaz_8backends_6cython_8_smaz_cy_compress __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("compress", 0);
  ...
  __pyx_t_1 = __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_compress(__pyx_v_data, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
...
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_3decompress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_decompress(__Pyx_memviewslice __pyx_v_data, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_6pysmaz_8backends_6cython_8_smaz_cy_decompress *__pyx_optional_args) {
  Py_ssize_t __pyx_v_output_size = ((Py_ssize_t)0);
  Py_ssize_t __pyx_v_input_len;
  PyObject *__pyx_v_output = 0;
  int __pyx_v_buffer_updated;
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":24
 * 
 * cpdef inline bytes decompress(const uint8_t[::1] data, Py_ssize_t output_size = 0):
 *     cdef Py_ssize_t input_len = data.shape[0]             # <<<<<<<<<<<<<<
 *     if output_size==0:
 *         output_size = input_len * 2 # buffer2
 */
  __pyx_v_input_len = (__pyx_v_data.shape[0]);

  /* "pysmaz/backends/cython/_smaz_cy.pyx":25
 * cpdef inline bytes decompress(const uint8_t[::1] data, Py_ssize_t output_size = 0):
 *     cdef Py_ssize_t input_len = data.shape[0]
 *     if output_size==0:             # <<<<<<<<<<<<<<
 *         output_size = input_len * 2 # buffer2
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "pysmaz/backends/cython/_smaz_cy.pyx":26
 *     cdef Py_ssize_t input_len = data.shape[0]
 *     if output_size==0:
 *         output_size = input_len * 2 # buffer2             # <<<<<<<<<<<<<<
 * 
 *     cdef bytes output = PyBytes_FromStringAndSize(NULL, output_size)
 */
    __pyx_v_output_size = (__pyx_v_input_len * 2);
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":28
 *         output_size = input_len * 2 # buffer2
 * 
 *     cdef bytes output = PyBytes_FromStringAndSize(NULL, output_size)             # <<<<<<<<<<<<<<
 *     if <void*>output == NULL:
 *         raise MemoryError
 */
  __pyx_t_2 = PyBytes_FromStringAndSize(NULL, __pyx_v_output_size); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_output = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "pysmaz/backends/cython/_smaz_cy.pyx":29
 * 
 *     cdef bytes output = PyBytes_FromStringAndSize(NULL, output_size)
 *     if <void*>output == NULL:             # <<<<<<<<<<<<<<
 *         raise MemoryError
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pysmaz/backends/cython/_smaz_cy.pyx":30
 *     cdef bytes output = PyBytes_FromStringAndSize(NULL, output_size)
 *     if <void*>output == NULL:
 *         raise MemoryError             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":32
 *         raise MemoryError
 * 
 *     cdef int buffer_updated = smaz_decompress(<char*>&data[0], <int>input_len, PyBytes_AS_STRING(output), <int>output_size)             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_3 = 0;
  __pyx_v_buffer_updated = smaz_decompress(((char *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_3)) ))))), ((int)__pyx_v_input_len), PyBytes_AS_STRING(__pyx_v_output), ((int)__pyx_v_output_size));

  /* "pysmaz/backends/cython/_smaz_cy.pyx":33
 * 
 *     cdef int buffer_updated = smaz_decompress(<char*>&data[0], <int>input_len, PyBytes_AS_STRING(output), <int>output_size)
 *     if buffer_updated == <int>output_size+1:             # <<<<<<<<<<<<<<
 *         raise ValueError("output buffer is too small")
 * 
 */
  __pyx_t_1 = ((__pyx_v_buffer_updated == (((int)__pyx_v_output_size) + 1)) != 0);
  if (unlikely(__pyx_t_1)) {

    /* "pysmaz/backends/cython/_smaz_cy.pyx":34
 *     cdef int buffer_updated = smaz_decompress(<char*>&data[0], <int>input_len, PyBytes_AS_STRING(output), <int>output_size)
 *     if buffer_updated == <int>output_size+1:
 *         raise ValueError("output buffer is too small")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":36
 *         raise ValueError("output buffer is too small")
 * 
 *     return output[:buffer_updated]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = PySequence_GetSlice(__pyx_v_output, 0, __pyx_v_buffer_updated); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("pysmaz.backends.cython._smaz_cy.decompress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_output);
  __Pyx_XGIVEREF(__pyx_r);
...
/* Python wrapper */
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_3decompress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6pysmaz_8backends_6cython_8_smaz_cy_2decompress[] = "decompress(const uint8_t[::1] data, Py_ssize_t output_size=0) -> bytes";
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_3decompress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  Py_ssize_t __pyx_v_output_size;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  __Pyx_RefNannySetupContext("decompress (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "decompress") < 0)) __PYX_ERR(0, 23, __pyx_L3_error)
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  2: values[1] = PyTuple_GET_ITEM(__pyx_args, 1);
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(values[0], 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    if (values[1]) {
      __pyx_v_output_size = __Pyx_PyIndex_AsSsize_t(values[1]); if (unlikely((__pyx_v_output_size == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L3_error)
    } else {
      __pyx_v_output_size = ((Py_ssize_t)0);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("decompress", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 23, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pysmaz.backends.cython._smaz_cy.decompress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_2decompress(__pyx_self, __pyx_v_data, __pyx_v_output_size);
...
static PyObject *__pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_2decompress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, Py_ssize_t __pyx_v_output_size) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_6pysmaz_8backends_6cython_8_smaz_cy_decompress __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("decompress", 0);
  ...
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.output_size = __pyx_v_output_size;
  __pyx_t_1 = __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_decompress(__pyx_v_data, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "pysmaz/backends/cython/_smaz_cy.pyx":39
 * 
 * 
...
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_5compress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE int __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_compress_into(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_output, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_output_size;
  int __pyx_v_ret;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":40
 * 
 * cpdef inline int compress_into(const uint8_t[::1] data, uint8_t[::1] output) except *:
 *     cdef Py_ssize_t output_size = output.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int ret =  smaz_compress(<char *> &data[0], <int> data.shape[0], <char*>&output[0], <int>output_size)
 ...
 */
  __pyx_v_output_size = (__pyx_v_output.shape[0]);

  /* "pysmaz/backends/cython/_smaz_cy.pyx":41
 * cpdef inline int compress_into(const uint8_t[::1] data, uint8_t[::1] output) except *:
 *     cdef Py_ssize_t output_size = output.shape[0]
 *     cdef int ret =  smaz_compress(<char *> &data[0], <int> data.shape[0], <char*>&output[0], <int>output_size)             # <<<<<<<<<<<<<<
 *     if ret == <int>output_size + 1:
 ...
 */
  __pyx_t_1 = 0;
  __pyx_t_2 = 0;
  __pyx_v_ret = smaz_compress(((char *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_1)) ))))), ((int)(__pyx_v_data.shape[0])), ((char *)(&(*((uint8_t *) ( /* dim=0 */ ((char *) (((uint8_t *) __pyx_v_output.data) + __pyx_t_2)) ))))), ((int)__pyx_v_output_size));

  /* "pysmaz/backends/cython/_smaz_cy.pyx":42
 *     cdef Py_ssize_t output_size = output.shape[0]
 *     cdef int ret =  smaz_compress(<char *> &data[0], <int> data.shape[0], <char*>&output[0], <int>output_size)
 *     if ret == <int>output_size + 1:             # <<<<<<<<<<<<<<
 *         raise ValueError("output buffer is too small")
 *     return ret
 */
  __pyx_t_3 = ((__pyx_v_ret == (((int)__pyx_v_output_size) + 1)) != 0);
  if (unlikely(__pyx_t_3)) {

    /* "pysmaz/backends/cython/_smaz_cy.pyx":43
 *     cdef int ret =  smaz_compress(<char *> &data[0], <int> data.shape[0], <char*>&output[0], <int>output_size)
 *     if ret == <int>output_size + 1:
 *         raise ValueError("output buffer is too small")             # <<<<<<<<<<<<<<
 *     return ret
 * 
 */
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 43, __pyx_L1_error)
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":44
 *     if ret == <int>output_size + 1:
 *         raise ValueError("output buffer is too small")
 *     return ret             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("pysmaz.backends.cython._smaz_cy.compress_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_5compress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6pysmaz_8backends_6cython_8_smaz_cy_4compress_into[] = "compress_into(const uint8_t[::1] data, uint8_t[::1] output) -> int";
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_5compress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_output,0};
    PyObject* values[2] = {0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_output)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("compress_into", 1, 2, 2, 1); __PYX_ERR(0, 39, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "compress_into") < 0)) __PYX_ERR(0, 39, __pyx_L3_error)
      }
    ...
    __pyx_v_output = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_output.memview)) __PYX_ERR(0, 39, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compress_into", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 39, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pysmaz.backends.cython._smaz_cy.compress_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_4compress_into(__pyx_self, __pyx_v_data, __pyx_v_output);
...
static PyObject *__pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_4compress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_output) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  if (unlikely(!__pyx_v_output.memview)) { __Pyx_RaiseUnboundLocalError("output"); __PYX_ERR(0, 39, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_compress_into(__pyx_v_data, __pyx_v_output, 0); if (unlikely(__pyx_t_1 == ((int)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L1_error)
...
/* "pysmaz/backends/cython/_smaz_cy.pyx":46
 *     return ret
 * 
 * cpdef inline int decompress_into(const uint8_t[::1] data, uint8_t[::1] output) except *:             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t output_size = output.shape[0]
...
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_7decompress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE int __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_decompress_into(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_output, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_output_size;
  int __pyx_v_ret;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":47
 * 
 * cpdef inline int decompress_into(const uint8_t[::1] data, uint8_t[::1] output) except *:
 *     cdef Py_ssize_t output_size = output.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int ret =  smaz_decompress(<char *> &data[0], <int> data.shape[0], <char*>&output[0], <int>output_size)
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":48
 * cpdef inline int decompress_into(const uint8_t[::1] data, uint8_t[::1] output) except *:
 *     cdef Py_ssize_t output_size = output.shape[0]
 *     cdef int ret =  smaz_decompress(<char *> &data[0], <int> data.shape[0], <char*>&output[0], <int>output_size)             # <<<<<<<<<<<<<<
 *     if ret == <int>output_size + 1:
 ...
 */
  __pyx_t_1 = 0;
  __pyx_t_2 = 0;
  __pyx_v_ret = smaz_decompress(((char *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_1)) ))))), ((int)(__pyx_v_data.shape[0])), ((char *)(&(*((uint8_t *) ( /* dim=0 */ ((char *) (((uint8_t *) __pyx_v_output.data) + __pyx_t_2)) ))))), ((int)__pyx_v_output_size));

  /* "pysmaz/backends/cython/_smaz_cy.pyx":49
 *     cdef Py_ssize_t output_size = output.shape[0]
 *     cdef int ret =  smaz_decompress(<char *> &data[0], <int> data.shape[0], <char*>&output[0], <int>output_size)
 *     if ret == <int>output_size + 1:             # <<<<<<<<<<<<<<
 *         raise ValueError("output buffer is too small")
 ...
 */
  ...
  if (unlikely(__pyx_t_3)) {
    ...
    /* "pysmaz/backends/cython/_smaz_cy.pyx":50
 *     cdef int ret =  smaz_decompress(<char *> &data[0], <int> data.shape[0], <char*>&output[0], <int>output_size)
 *     if ret == <int>output_size + 1:
 *         raise ValueError("output buffer is too small")             # <<<<<<<<<<<<<<
 *     return ret
 */
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_Raise(__pyx_t_4, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":51
 *     if ret == <int>output_size + 1:
 *         raise ValueError("output buffer is too small")
 *     return ret             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("pysmaz.backends.cython._smaz_cy.decompress_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_7decompress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6pysmaz_8backends_6cython_8_smaz_cy_6decompress_into[] = "decompress_into(const uint8_t[::1] data, uint8_t[::1] output) -> int";
static PyObject *__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_7decompress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_output = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  __Pyx_RefNannySetupContext("decompress_into (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_output)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("decompress_into", 1, 2, 2, 1); __PYX_ERR(0, 46, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "decompress_into") < 0)) __PYX_ERR(0, 46, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(values[0], 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 46, __pyx_L3_error)
    __pyx_v_output = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_output.memview)) __PYX_ERR(0, 46, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("decompress_into", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 46, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pysmaz.backends.cython._smaz_cy.decompress_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_6decompress_into(__pyx_self, __pyx_v_data, __pyx_v_output);
...
static PyObject *__pyx_pf_6pysmaz_8backends_6cython_8_smaz_cy_6decompress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_output) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  if (unlikely(!__pyx_v_output.memview)) { __Pyx_RaiseUnboundLocalError("output"); __PYX_ERR(0, 46, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_6pysmaz_8backends_6cython_8_smaz_cy_decompress_into(__pyx_v_data, __pyx_v_output, 0); if (unlikely(__pyx_t_1 == ((int)-1) && PyErr_Occurred())) __PYX_ERR(0, 46, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pysmaz.backends.cython._smaz_cy.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pysmaz.backends.cython._smaz_cy.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pysmaz.backends.cython._smaz_cy.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pysmaz.backends.cython._smaz_cy._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"compress", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_1compress, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6pysmaz_8backends_6cython_8_smaz_cy_compress},
  {"decompress", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_3decompress, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6pysmaz_8backends_6cython_8_smaz_cy_2decompress},
  {"compress_into", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_5compress_into, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6pysmaz_8backends_6cython_8_smaz_cy_4compress_into},
  {"decompress_into", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6pysmaz_8backends_6cython_8_smaz_cy_7decompress_into, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6pysmaz_8backends_6cython_8_smaz_cy_6decompress_into},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__smaz_cy(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__smaz_cy},
  {0, NULL}
};
#endif
 ...
 *     return output[:buffer_updated]
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_output_buffer_is_too_small); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 19, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_smaz_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_smaz_cy(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__smaz_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__smaz_cy(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__smaz_cy(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_smaz_cy' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__smaz_cy(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_smaz_cy", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pysmaz__backends__cython___smaz_cy) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pysmaz.backends.cython._smaz_cy")) {
      if (unlikely(PyDict_SetItemString(modules, "pysmaz.backends.cython._smaz_cy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pysmaz/backends/cython/_smaz_cy.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pysmaz.backends.cython._smaz_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pysmaz.backends.cython._smaz_cy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
